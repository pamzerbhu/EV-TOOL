...
void test_runtime_force_activate_overrides_when_bit_clear()
{
    bypassTlsscRequirementRuntime = false;
...
void test_runtime_defaults_start_disabled()
{
    ...
    TEST_ASSERT_FALSE(forceActivateRuntime);
...
int main()
{
    ...
    RUN_TEST(test_runtime_force_activate_overrides_when_bit_clear);
